...
import com.leinardi.forlago.library.preferences.interactor.GetMaterialYouFlowInteractorImpl.Companion.MATERIAL_YOU_PREF_KEY
...
internal class StoreMaterialYouInteractorImpl @Inject constructor(
    ...
    override suspend operator fun invoke(enabled: Boolean) {
        userDataStoreRepository.storeValue(MATERIAL_YOU_PREF_KEY, enabled)
    }
}
