...
import com.leinardi.forlago.library.preferences.interactor.ReadEnvironmentInteractorImpl.Companion.ENVIRONMENT_PREF_KEY
...
internal class StoreEnvironmentInteractorImpl @Inject constructor(
    ...
    override suspend operator fun invoke(environment: ReadEnvironmentInteractor.Environment) {
