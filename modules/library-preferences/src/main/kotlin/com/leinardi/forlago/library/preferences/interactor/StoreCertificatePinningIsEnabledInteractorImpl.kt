...
internal class StoreCertificatePinningIsEnabledInteractorImpl @Inject constructor(
    ...
    override suspend operator fun invoke(isEnabled: Boolean) {
        appDataStoreRepository.storeValue(ReadCertificatePinningIsEnabledInteractorImpl.CERTIFICATE_PINNING_IS_ENABLED, isEnabled)
    }
}
