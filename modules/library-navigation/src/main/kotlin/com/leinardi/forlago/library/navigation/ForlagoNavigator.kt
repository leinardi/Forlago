...
import com.leinardi.forlago.library.navigation.destination.foo.FooDestination
...
class ForlagoNavigator @Inject constructor() {
     ...
     */
    fun handleDeepLink(intent: Intent): Boolean = navigationEvents.trySend(NavigatorEvent.HandleDeepLink(intent)).isSuccess
