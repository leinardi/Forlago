...
class RefreshAccessTokenInteractor @Inject constructor() {
    ...
    sealed class Result {
        ...
        sealed class Failure : Result() {
            data class BadAuthentication(val code: Int) : Result.Failure()
            data class NetworkError(val throwable: Throwable) : Result.Failure()
            data class UnexpectedError(val throwable: Throwable, val code: Int? = null) : Result.Failure()
        }
    }
}
