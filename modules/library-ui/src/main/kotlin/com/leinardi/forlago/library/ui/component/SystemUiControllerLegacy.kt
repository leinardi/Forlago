 ...
 */
@Stable
public interface SystemUiControllerLegacy {
    /**
...
/**
 * Remembers a [SystemUiControllerLegacy] for the given [window].
 *
 ...
 * returned [SystemUiControllerLegacy] will be degraded, but won't throw an exception.
 */
@Composable
public fun rememberSystemUiControllerLegacy(
    window: Window? = findWindow(),
): SystemUiControllerLegacy {
 ...
 *
 * Typically you would use [rememberSystemUiControllerLegacy] to remember an instance of this.
 */
 ...
 */
val navigationBarDefaultLightScrim = android.graphics.Color.argb(0xe6, 0xFF, 0xFF, 0xFF)

/**
 * The default dark scrim, as defined by androidx and the platform:
 * https://cs.android.com/androidx/platform/frameworks/support/+/androidx-main:activity/activity/src/main/java/androidx/activity/EdgeToEdge.kt;l=40-44;drc=27e7d52e8604a080133e8b842db10c89b4482598
 */
val navigationBarDefaultDarkScrim = android.graphics.Color.argb(0x80, 0x1b, 0x1b, 0x1b)
